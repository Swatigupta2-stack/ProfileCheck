...
interface UpgradeButtonProps {
  user: any; // Can be Supabase User or custom User
}
...
export function UpgradeButton({ user }: UpgradeButtonProps) {
  ...
  if (isPro) {
    return (
      <Button disabled className="w-full bg-gradient-to-r from-amber-500 to-yellow-500 text-white font-bold cursor-default">
  ...
  return (
    <>
      <Button onClick={() => setIsModalOpen(true)} className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold shadow-glow">
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-md bg-card border-border/80">
          <DialogHeader>
            ...
            <DialogDescription>
              Get unlimited resumes and access to all premium templates for 30 days!
            </DialogDescription>
          </DialogHeader>
